...
/app/python/source_code/.venv/bin/python -m mlflow autolog claude \
  -u databricks -e 122546556359397 -y
# verify:
...
`122546556359397`. The experiment also holds 16 older `claude_code_conversation`
...
databricks api post /api/3.0/mlflow/traces/search --json \
  '{"locations":[{"mlflow_experiment":{"experiment_id":"122546556359397"}}],"max_results":20}'
```
