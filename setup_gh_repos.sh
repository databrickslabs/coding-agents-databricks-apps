...
DEFAULT_REPOS=(
  "dgokeeffe/agentic-engineering-with-databricks"
  "dgokeeffe/coding-agents-databricks-apps-private"
  "dgokeeffe/databricks-mlflow-lakebase-tracing"
  "dgokeeffe/omnigent"
  "dgokeeffe/ppcs-challenge"
)
